...
function EnderecoFormTeste() {
  const [form] = Form.useForm();

  const cepValue = Form.useWatch(["endereco", "cep"], form);
  ...
  const getRegiaoPorUF = (uf) => {
    ...
    return Object.keys(regioes).find((r) => regioes[r].includes(uf)) || "";
  };
...
export default EnderecoFormTeste;
